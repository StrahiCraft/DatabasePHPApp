...
$currentTable = "moderatori_igrice";

echo "Uspesno uspostavljena konekcija ka bazi";

if(isset($_GET['delete_id'])){
    $sql_query = "DELETE FROM ".$currentTable." WHERE id_moderatora_igrice =".$_GET['delete_id'];
...
<html>
    ...
    <body>
        <div class = "tabela">
            ...
            <table align = "center">
                <tr>
                    <th colspan="4"><a href = "javascript:add_data('<?php echo $currentTable; ?>')" class = "add-data">Dodaj podatak</a></th>
                </tr>
                <tr class = "row-header">
                    <th>ID moderatora</th>
                    <th>ID igrice</th>
